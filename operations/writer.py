...
class Writer():
    ...
    _DESIRED_COL_ORDER = ["contract_id","contract_name", "money_flow", "contract_partner", "contract_type",
                          "contract_valid_date", "contract_status", "contract_sum","organization", "department", "project_id", "project_name",
                          "nc_code", "project_sum", "proj_category_1", "proj_category_2", "proj_type",
                          "contract_model", "voltage_lvl", "proj_manager", "proj_status",
                          "proj_regis_date", "proj_startDate", "proj_endDate"]
